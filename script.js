...
function sendMessage(){
	...
	if (textboxMessage != ""){
		...
		if (foundKeyword){
			...
			if (isEnglish){
				message.innerText = "I may have found some information related to your keyword(s). Please see on the right hand side.";
			}else {
				message.innerText = "J’ai peut-être trouvé de l'information liée à votre mot-clé. Veuillez SVP regarder à droite de l'écran.";
			}
	...
	if (isTyping == false){
			...
			if (firstTime == true){
				...
				if (isEnglish){
					...
					message.innerText = "Est-ce qu'il y a autre chose que je puisse vous aider ?";
				}
